...
<script src="<c:url value="/webjars/sockjs-client/1.1.2/sockjs.js" />" type="text/javascript"></script>
<script src="<c:url value="/resources/static/js/stomp.js"/>" type="text/javascript"></script>
